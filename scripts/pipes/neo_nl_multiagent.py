...
async def emit_status(emitter, phase: str, done: bool = False, **kwargs):
    ...
    if kwargs:
        try:
            ...
            pass  # If format string doesn't match kwargs, use as-is
...
# =============================================================================
# GRAPH NODES - STANDARD PATH (from original pipe)
# =============================================================================
...
# =============================================================================
# GRAPH NODES - MULTI-AGENT PATH (new)
# =============================================================================
