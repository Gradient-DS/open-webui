...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('completed', 10, 21600, 'empty'),  # done on warren but file still processing → zero-chunk skip
        ('running', 21601, 21600, 'timeout'),  # hung past the generous backstop → error
        ('completed', 99999, 21600, 'empty'),  # completed-but-unfulfilled wins over the wall-clock timeout
