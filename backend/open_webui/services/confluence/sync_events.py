"""Socket.IO event emitter for Confluence sync progress.

Delegates to the shared sync events module with the Confluence event prefix.
"""
...
async def emit_file_processing(
    ...
    """Emit event when a page starts processing during Confluence sync."""
...
async def emit_file_added(
    ...
    """Emit event when a page is successfully added to the knowledge base."""
