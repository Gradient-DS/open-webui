...
4. **Standard formats**: Chat export uses a proprietary JSON format (array of `ChatResponse`). There's OpenAI format detection for *import* but not for *export*. No standard like ActivityPub, JSON-LD, or MBOX is used.
