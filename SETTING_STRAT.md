## Main
- Chat controls disable for both
- Capture off for everybody
- Chatoverzicht feature flag
...
## Voice
- Make a feature flag
- Make sure settings are included

## Notes
- Chat and controls need to be disabled for admin and user
...
We can set the model systemprompt in the admin panel, perfect!