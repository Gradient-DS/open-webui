...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
	...
	>
		...
		{/if}
			...
			{#if isAdminSettingsTabEnabled('connections')}
			<button
				id="connections"
		...
		{/if}
			...
			{#if isAdminSettingsTabEnabled('models')}
			<button
				id="models"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'models'
		...
		{#if isAdminSettingsTabEnabled('evaluations')}
			<button
				id="evaluations"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'evaluations'
		...
		{#if isAdminSettingsTabEnabled('tools')}
			<button
				id="tools"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'tools'
		...
		{#if isAdminSettingsTabEnabled('documents')}
			<button
				id="documents"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'documents'
		...
		{#if isAdminSettingsTabEnabled('web')}
			<button
				id="web"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'web'
		...
		{#if isAdminSettingsTabEnabled('code-execution')}
			<button
				id="code-execution"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'code-execution'
		...
		{#if isAdminSettingsTabEnabled('interface')}
			<button
				id="interface"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'interface'
		...
		{#if isAdminSettingsTabEnabled('audio')}
			<button
				id="audio"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'audio'
		...
		{#if isAdminSettingsTabEnabled('images')}
			<button
				id="images"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'images'
		...
		{#if isAdminSettingsTabEnabled('pipelines')}
			<button
				id="pipelines"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'pipelines'
		...
		{#if isAdminSettingsTabEnabled('email')}
			<button
				id="email"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'email'
			...
			>
				...
				<div class=" self-center">{$i18n.t('Email')}</div>
			</button>
		{/if}

		{#if isAdminSettingsTabEnabled('db')}
			<button
				id="db"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'db'
		...
		{#if isAdminSettingsTabEnabled('acceptance')}
			<button
				id="acceptance"
				class="px-0.5 py-1 min-w-fit rounded-lg flex-1 md:flex-none flex text-left transition {selectedTab ===
				'acceptance'
					...
					: ' text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'}"
				on:click={() => {
					goto('/admin/settings/acceptance');
				}}
			>
				<div class=" self-center mr-2">
					<svg
