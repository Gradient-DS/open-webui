"""Socket.IO event emitter for TOPdesk sync progress.

Delegates to the shared sync events module with the TOPdesk event prefix.
"""
...
async def emit_file_processing(
    ...
    """Emit event when an item starts processing during TOPdesk sync."""
...
async def emit_file_added(
    ...
    """Emit event when an item is successfully added to the knowledge base."""
