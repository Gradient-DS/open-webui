...
export const getInviteContent = async (token: string) => {
	let error = null;
...
export const setInviteContent = async (token: string, subject: string, heading: string) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/configs/invite_content`, {
		...
		body: JSON.stringify({ subject, heading })
	})
		.then(async (res) => {
			if (!res.ok) throw await res.json();
			return res.json();
...
export const getEmailConfig = async (token: string) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/configs/email`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const setEmailConfig = async (token: string, emailConfig: object) => {
	let error = null;
...
export const testEmailConfig = async (token: string) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/configs/email/test`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const get2FAConfig = async (token: string) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/configs/2fa`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getGoogleDriveConfig = async (token: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/configs/google_drive`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const setGoogleDriveConfig = async (token: string, config: object) => {
	let error = null;
...
export const getOneDriveConfig = async (token: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/configs/onedrive`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const setOneDriveConfig = async (token: string, config: object) => {
	let error = null;
...
export const getConfluenceConfig = async (token: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/configs/confluence`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const setConfluenceConfig = async (token: string, config: object) => {
	let error = null;
...
export const getTopdeskConfig = async (token: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/configs/topdesk`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const setTopdeskConfig = async (token: string, config: object) => {
	let error = null;
